        ...
        initDashboardDaterange: function() {
            ...
            $('#dashboard-report-range').daterangepicker({
                "ranges": {
                    ...
                    '前七日': [moment().subtract('days', 6), moment()],
                    '前三十日': [moment().subtract('days', 29), moment()],
            	...
            	window.location = "/?start_date=" + start_date + "&end_date=" + end_date;
            });

            //$('#dashboard-report-range span').html(moment().subtract('days', 29).format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
            //$('#dashboard-report-range span').html(moment().startOf('year').format('YYYY-MM-DD') + ' 至 ' + moment().subtract('days', 1).format('YYYY-MM-DD'));
            $('#dashboard-report-range span').html(START_DATE + ' 至 ' + END_DATE);
